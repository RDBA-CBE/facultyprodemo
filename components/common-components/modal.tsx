    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent
        ...
        onInteractOutside={(e) => {
          ...
          if (
            target?.closest(".react-joyride") ||
            target?.closest("#react-joyride-portal") ||
            target?.closest(".__floater") ||
            target?.closest("[data-test-id='overlay']") ||
            (target as any)?.classList?.contains("react-joyride__overlay")
          ) return;
          e.preventDefault();
        }}
